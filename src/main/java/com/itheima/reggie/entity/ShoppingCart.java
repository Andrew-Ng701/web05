...
public class ShoppingCart implements Serializable {
    ...
    public String toString() {
        return "ShoppingCart{id = " + id + ", name = " + name + ", userId = " + userId + ", dishId = " + dishId + ", setmealId = " + setmealId + ", dishFlavor = " + dishFlavor + ", number = " + number + ", amount = " + amount + ", image = " + image + ", createTime = " + createTime + "}";
    }
}
